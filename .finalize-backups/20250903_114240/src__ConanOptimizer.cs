...
{
    public class ConanOptimizerMainForm : Form
    {
        #region Constants
    ...
    public ConanOptimizerMainForm()
        ...
        {
            // Steam-/Conan-Status bleibt wie bisher gesetzt
            try
            {
            ...
            {
                systemStatusLabel.Text = "💻 System: Informationen nicht verfügbar";
